...
$sql="SELECT kayttaja.id, kayttaja.nimi, kayttaja_ilmoitus2.ilmoitus, kayttaja_ilmoitus2.id  FROM kayttaja 
...
// yks id
$sql = "DELETE FROM kayttaja_ilmoitus2 
WHERE kayttaja_ilmoitus2.id = '" . $idarvo . "'";
