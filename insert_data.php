...
$sql="SELECT kayttaja_ilmoitus2.ilmoitus FROM kayttaja_ilmoitus2 WHERE kayttaja_ilmoitus2.kayttajaid =
...
$sql2 = "insert into kayttaja_ilmoitus2(ilmoitus, kayttajaid, pvm) values ('$insert_teksti', '$insert_kaytid', '$dateandtime')";
