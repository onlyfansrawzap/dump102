...
$sql = $sql="SELECT kayttaja.id, kayttaja.nimi, kayttaja_ilmoitus.ilmoitus FROM kayttaja 
...
$sql = "UPDATE kayttaja_ilmoitus SET ilmoitus = " . "'" . $uusinimiget . "'" . ", kayttaja_ilmoitus.pvm ='" . $pvmnameget . "' WHERE kayttaja_ilmoitus.kayttajaid = '" . $SESSION['myuserid'] . "'" . " AND kayttaja_ilmoitus.ilmoitus = '" . $idget . "'";
